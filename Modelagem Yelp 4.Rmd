...
split <- initial_split(yelp_rv, prop = 2/3 , strata = stars)
...
split_val <- initial_split(train_val, prop = 1/2, strata = stars)
...
network <- keras_model_sequential() %>% 
  layer_dense(units = 64, activation = "tanh", input_shape = ncol(x_tr)) %>%
...
network %>% 
  fit(x_tr, y_tr, epochs = 40, batch_size = 16, 
