...
yelp %>% 
  ggplot(aes(longitude, latitude, color = stars_usr)) +
  geom_point(size = 0.5, alpha = 0.7) +
  scale_color_gradient(low = 'skyblue', high = 'darkred', labels = scales::label_number_si()) +
  labs(title = 'Average Stars by user')
...
yelp %>% 
  ggplot(aes(longitude, latitude, color = stars_bz)) +
  geom_point(size = 0.5, alpha = 0.7) +
  scale_color_gradient(low = 'skyblue', high = 'gold', labels = scales::label_number_si()) +
  labs(title = 'Average Stars by Business')
...
yelp %>% 
  ggplot(aes(longitude, latitude, color = review_count)) +
  geom_point(size = 0.5, alpha = 0.7) +
  scale_color_gradient(low = 'skyblue', high = 'green', labels = scales::label_number_si()) +
  labs(title = 'Review count by Business')
